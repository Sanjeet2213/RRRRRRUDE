...
@Bot.on_message((filters.document | filters.video | filters.audio | filters.photo) &  filters.user(Config.BOT_OWNER) & ~filters.chat(Config.DB_CHANNEL))
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Sorry, You are banned!\n\nContact [Support Group](https://telegram.me/Joint0T)",
                                     disable_web_page_preview=True)
            return
        ...
        await message.reply_text(
            ...
            disable_web_page_preview=True
            # ,
            # protect_content=True                                                          # ( ----------> Saved to Batch Line)
        )
    ...
    if "aboutbot" in cb_data:
                ...
                [
                    [
                        InlineKeyboardButton("Source Codes of Bot",
                                             url="https://github.com/Rudraa2213")
                    ],
                    [
        ...
        if UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://telegram.me/Joint0T).",
                        disable_web_page_preview=True
                    )
                    return
            except UserNotParticipant:
                ...
                await cmd.message.edit(
                    text="Something went Wrong. Contact my [Support Group](https://telegram.me/Joint01).",
                    disable_web_page_preview=True
                )
                return
        await cmd.message.edit(
